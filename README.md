...
- 공개 OCR/PDF 책의 **두 페이지 펼침**, 곡면 종이 컬, 앞·뒷면, 동적 그림자 기반 드래그·스와이프·키보드 책 넘김과 연속 읽기 전환
- 포인터에 반응하는 서재 표지의 절제된 입체 기울기·광택·종이 가장자리
...
- [2026-08-08 · EPUBIA 1.6.0 곡면 종이책 리더](docs/2026-08-08-page-turn-reader.md)
